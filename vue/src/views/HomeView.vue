...
<template>
  ...
  <!-- <head>
        <title>GuidedCents</title>
        <link rel="stylesheet" href="./heap_frontend/css/mainpage_firstClick.css">
...
.mainPic{
    background: linear-gradient(rgba(255,255,255,0.5), rgba(255,255,255,0.5)),url("img/mainMoney2.jpg");
